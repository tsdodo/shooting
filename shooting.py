...
def setup():
    """初期設定を行う関数"""
    global screen, font, button_font, retry_button_rect, quit_button_rect, background_img
    ...
    # ボタンの設定
    # リトライボタンの位置とサイズ
    retry_button_rect = pygame.Rect(SCREEN_WIDTH // 2 - 110, SCREEN_HEIGHT // 2, 100, 50) 
    # 終了ボタンの位置とサイズ
...
def main():
    ...
    while running:
        ...
        if not game_over:
            ...
            # 新しい敵を追加
            if random.randint(1, ENEMY_PROB_PER_FRAME) == 1:
